        ...
        <form action="index.php?action=editar&id=<?= $expediente->id ?>" method="POST" enctype="multipart/form-data">
            ...
            <fieldset>
                ...
                <?php if ($expediente->archivo): ?>
                    <p>Foto <img src="https://franco.104cubes.com/MODULO_2/PHP/041_Ejercicio_31/uploads/<?= htmlspecialchars($expediente->archivo); ?>" class="foto-alumno" alt="Foto Alumno"></p>
                <?php endif; ?>
            </fieldset>
